...
diesel::table! {
    ...
    github_pr (github_repo_id, github_pr_number) {
        ...
        /// (Automatically generated by Diesel.)
        author_id -> Int8,
        /// The `reviewer_ids` column of the `github_pr` table.
        ///
        ...
        /// The `merge_ci_run_id` column of the `github_pr` table.
        ///
...
diesel::joinable!(github_pr -> github_ci_runs (merge_ci_run_id));
